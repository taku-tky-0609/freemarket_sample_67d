...
# lady = Categoris.create(name: "レディース")
...
# # ベビー・キッズ
# baby_kids = Categoris.create(name: "ベビー・キッズ")
...
# # インテリア・住まい・小物
# interior_residence_accessory = Categoris.create(name: "インテリア・住まい・小物")
...
# # 本・音楽・ゲーム
# book_music_game = Categoris.create(name: "本・音楽・ゲーム")
...
# # おもちゃ・ホビー・グッズ
# toy_hobby_goods = Categoris.create(name: "おもちゃ・ホビー・グッズ")
...
# # コスメ・香水・美容
# cosme_perfume_beauty = Categoris.create(name: "コスメ・香水・美容")
...
# # 家電・スマホ・カメラ
# appliance_smartphone_camera = Categoris.create(name: "家電・スマホ・カメラ")
...
# # スポーツ・レジャー
# sport_leisure = Categoris.create(name: "スポーツ・レジャー")
...
# # ハンドメイド
# handmade = Categoris.create(name: "ハンドメイド")
...
# # チケット
# ticket = Categorissss.create(name: "チケット")
...
# # 自動車・オートバイ
# car_motorcycle = Categoris.create(name: "自動車・オートバイ")
...
# # その他
# others = Categoris.create(name: "その他")
