...
lady = Categori.create(name: "レディース")
...
# ベビー・キッズ
baby_kids = Categori.create(name: "ベビー・キッズ")
...
# インテリア・住まい・小物
interior_residence_accessory = Categori.create(name: "インテリア・住まい・小物")
...
# 本・音楽・ゲーム
book_music_game = Categori.create(name: "本・音楽・ゲーム")
...
# おもちゃ・ホビー・グッズ
toy_hobby_goods = Categori.create(name: "おもちゃ・ホビー・グッズ")
...
# コスメ・香水・美容
cosme_perfume_beauty = Categori.create(name: "コスメ・香水・美容")
...
# 家電・スマホ・カメラ
appliance_smartphone_camera = Categori.create(name: "家電・スマホ・カメラ")
...
# スポーツ・レジャー
sport_leisure = Categori.create(name: "スポーツ・レジャー")
...
# ハンドメイド
handmade = Categori.create(name: "ハンドメイド")
...
# チケット
ticket = Categori.create(name: "チケット")
...
# 自動車・オートバイ
car_motorcycle = Categori.create(name: "自動車・オートバイ")
...
# その他
others = Categori.create(name: "その他")
